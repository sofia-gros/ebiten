...
import (
	...
	"github.com/sofia-gros/ebiten/physics/adapters/box2dgo"
)
...
func NewGame() *Game {
	...
	// Box2D-Goエンジンをセット
	g.physManager.SetWorld(box2dgo.NewWorld())
	// 共通で重力をセット
...
func (g *Game) Draw(screen *ebiten.Image) {
	...
	ebitenutil.DebugPrint(screen, "Ebiten Physics: Box2D-Go Engine")
}
...
func main() {
	...
	ebiten.SetWindowTitle("Ebiten Physics - Box2D-Go Example")
